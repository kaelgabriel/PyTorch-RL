...
FILE=/home/gabriel/repos/PyTorch-RL/checkpoint/name_Testing_norm_deterministic_clip_0.2_minbatch_2048_lr_0.0003_optepochs_10_optbatchs_64_init_Discretized_Uniform_seed_42_GAIL/GAIL_Testing_norm_deterministic_itr_649.p
